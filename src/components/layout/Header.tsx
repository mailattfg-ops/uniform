    ...
    <header className="h-20 bg-background/80 backdrop-blur-md sticky top-0 z-40 px-6 lg:px-10 flex items-center justify-between transition-all duration-300 ">
      ...
      <div className="flex items-center gap-4">
        <button 
          ...
          className="p-2.5 rounded-2xl bg-white shadow-sm border border-border hover:shadow-md transition-all lg:hidden text-muted-foreground active:scale-95"
        >
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative ml-2" ref={menuRef}>
          <button 
            ...
            className="flex items-center gap-2 p-1.5 pr-3 rounded-[2rem] bg-white shadow-sm border border-border hover:shadow-md transition-all active:scale-95 group"
          >
          ...
          {/* Dropdown Menu */}
          {isMenuOpen && (
            <div className="absolute right-0 mt-4 w-64 bg-white rounded-[2.5rem] shadow-2xl border border-zinc-100 p-3 animate-in fade-in slide-in-from-top-4 duration-300 scale-100 origin-top-right z-50 overflow-hidden">
               ...
               <div className="space-y-1">
                 <Link 
                   href="/profile" 
                   className="flex items-center gap-4 px-5 py-3 rounded-2xl text-xs font-bold text-zinc-600 hover:bg-[#fce4d4] hover:text-[#2d8d9b] transition-all group"
                 >
                 ...
                 <div className="h-[1px] bg-zinc-50 my-2 mx-5" />
                 <button 
