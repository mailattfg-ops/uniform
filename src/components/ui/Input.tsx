    ...
    <div className="flex flex-col gap-2 w-full group">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          } rounded-[1.2rem] focus:outline-none focus:ring-4 focus:ring-[#fce4d4]/30 focus:border-[#2d8d9b] transition-all text-sm font-bold text-foreground placeholder:text-zinc-300 dark:placeholder:text-zinc-700 shadow-sm ${
            icon ? 'pl-12' : ''
          } ${className}`}
          {...props}
        />
